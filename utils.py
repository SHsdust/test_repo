...
swda_label2id = {'qw^d': 0, '^2': 1, 'b^m': 2, 'qy^d': 3, '^h': 4, 'bk': 5, 'b': 6, 'fa': 7, 'sd': 8, 'fo_o_fw_"_by_bc': 9,
...
# swda_labels = {
#     0: 'declarative wh-question like you are what kind of buff ?',  # 'qw^d'
#     1: 'collaborative completion like who aren\'t contributing .',  # '^2'
#     2: 'repeat phrase like oh , fajitas',  # 'b^m'
#     3: 'declarative yes-no-question like so you can afford to get a house ?',  # 'qy^d'
#     4: 'hold before answer / agreement like i\'m drawing a blank .',  # '^h'
#     5: 'response acknowledgement like oh , okay .',  # 'bk'
#     6: 'acknowledge (backchannel) like Uh-huh .',  # 这个后面可能需要改一下  'b'
#     7: 'apology like i\'m sorry .',  # 'fa
#     8: 'statement-non-opinion like me , i\'m in the legal department .',  # 'sd
#     9: 'other like well give me a break , you know .',  # 'fo_o_fw_"_by_bc'
#     10: 'action-directive like why don\'t you go first',  # 'ad'
#     11: 'appreciation like i can imagine .',  # 'ba'
#     12: 'negative none or no answers like uh , not a whole lot .',  # 'ng'
#     13: 'self-talk like what\'s the word i\'m looking for',  # 't1'
#     14: 'downplayer like that\'s all right .',  # 'bd'
#     15: 'rhetorical-questions like who would steal a newspaper ?',  # 'qh'
#     16: 'signal-non-understanding like excuse me ?',  # 'br'
#     17: 'open-question like how about you ?',  # 'qo'
#     18: 'no answers like no .',  # 'nn'
#     19: 'dispreferred answers like well , not so much that .',  # 'arp_nd'
#     20: 'conventional-opening like how are you ?',  # 'fp'
#     21: 'maybe accept-part like something like that',  # 'app_am'
#     22: 'offers options commits like i\'ll have to check that out',  # 'oo_co_cc'
#     23: 'hedge like i don\'t know if i\'m making any sense or not .',  # 'h'
#     24: 'or-clause like or is it more of a company ?',  # 'qrr'
#     25: 'affirmative non-yes answers like it is .',  # 'na'
#     26: 'non-verbal like laughter , throat clearing',  # 'x'
#     27: 'backchannel in question form like is that right ?',  # 'bh'
#     28: 'conventional closing like well , it\'s been nice talking to you .',  # 'fc'
#     29: 'agree or accept like that\'s exactly it .',  # 'aa'
#     30: '3rd-party-talk like my goodness , diane , get down from there .',  # 't3'
#     31: 'other answers like i don\'t know',  # 'no'
#     32: 'uninterpretable like so -',  # utterance会以'-/'结尾  '%'
#     33: 'tag-question like right ?',  # '^g'
#     34: 'yes-no-question like do you have to have any special training ?',  # 'qy'
#     35: 'statement-opinion like i think it\'s great',  # 'sv'
#     36: 'thanking like hey thanks a lot',  # 'ft'
#     37: 'quotation like you can\'t be pregnant and have cats',  # '^q'
#     38: 'summarize reformulate like oh , you mean you switched schools for the kids .',  # 'bf'
#     39: 'wh-question like well , how old are you ?',  # 'qw'
#     40: 'yes answers like yes .',  # 'ny'
#     41: 'reject like no .',  # 'ar'
#     42: 'multi utterance'  # '+'
# }

swda_labels = {
    0: 'declarative wh-question',  # 'qw^d'
    1: 'collaborative completion',  # '^2'
    2: 'repeat phrase',  # 'b^m'
    3: 'declarative yes-no-question',  # 'qy^d'
    4: 'hold before answer / agreement',  # '^h'
    5: 'response acknowledgement',  # 'bk'
    6: 'acknowledge (backchannel)',  # 这个后面可能需要改一下  'b'
    7: 'apology',  # 'fa
    8: 'statement-non-opinion',  # 'sd
    9: 'other',  # 'fo_o_fw_"_by_bc'
    10: 'action-directive',  # 'ad'
    11: 'appreciation',  # 'ba'
    12: 'negative none or no answers',  # 'ng'
    13: 'self-talk',  # 't1'
    14: 'downplayer',  # 'bd'
    15: 'rhetorical-questions',  # 'qh'
    16: 'signal-non-understanding',  # 'br'
    17: 'open-question',  # 'qo'
    18: 'no answers',  # 'nn'
    19: 'dispreferred answers',  # 'arp_nd'
    20: 'conventional-opening',  # 'fp'
    21: 'maybe accept-part',  # 'app_am'
    22: 'offers options commits',  # 'oo_co_cc'
    23: 'hedge',  # 'h'
    24: 'or-clause',  # 'qrr'
    25: 'affirmative non-yes answers',  # 'na'
    26: 'non-verbal',  # 'x'
    27: 'backchannel in question form',  # 'bh'
    28: 'conventional closing',  # 'fc'
    29: 'agree or accept',  # 'aa'
    30: '3rd-party-talk',  # 't3'
    31: 'other answers',  # 'no'
    32: 'uninterpretable',  # utterance会以'-/'结尾  '%'
    33: 'tag-question?',  # '^g'
    34: 'yes-no-question',  # 'qy'
    35: 'statement-opinion',  # 'sv'
    36: 'thanking',  # 'ft'
    37: 'quotation',  # '^q'
    38: 'summarize reformulate',  # 'bf'
    39: 'wh-question',  # 'qw'
    40: 'yes answers',  # 'ny'
    41: 'reject',  # 'ar'
    42: 'multi utterance'  # '+'
